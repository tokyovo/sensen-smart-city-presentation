...
export const SlideRenderer: React.FC<SlideRendererProps> = ({ slide, theme }) => {
  if (slide.type === SlideType.TITLE) {
    if (theme === 'light') {
      return (
        <div className="h-full flex flex-col items-center justify-center text-center p-12 bg-white rounded-xl shadow-xl relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full opacity-5 pointer-events-none">
            <div className="absolute right-0 bottom-0 w-96 h-96 bg-blue-500 rounded-full blur-3xl"></div>
          </div>

          <div className="z-10 space-y-8">
            <div className="mb-6 inline-block p-4 bg-blue-600 rounded-lg shadow-lg">
            ...
            <h2 className="text-xl md:text-2xl text-blue-600 font-semibold max-w-3xl mx-auto">
              {slide.subtitle}
            </h2>
  ...
  if (slide.type === SlideType.ECOSYSTEM && slide.diagramLayers) {
      return <EcosystemSlide layers={slide.diagramLayers} theme={theme} />;
  }

  // Content slides
  if (theme === 'light') {
    return (
      <div className="h-full bg-white rounded-xl border border-slate-200 p-6 md:p-8 shadow-xl flex flex-col overflow-y-auto">
        {/* Header */}
        <div className="mb-6 border-b-2 border-blue-100 pb-4">
          ...
          <h3 className="text-base text-blue-600 font-semibold">{slide.subtitle}</h3>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-red-50 p-4 rounded-xl border-2 border-red-200">
              <div className="flex items-center gap-2 mb-3 text-red-700">
                ...
                <h4 className="font-bold text-base">The Problem</h4>
              </div>
            ...
            {/* Solution */}
            <div className="bg-green-50 p-4 rounded-xl border-2 border-green-200 flex-grow">
              <div className="flex items-center gap-2 mb-3 text-green-700">
                <CheckCircle2 size={20} strokeWidth={2.5} />
                <h4 className="font-bold text-base">The Solution</h4>
              </div>
              <p className="text-slate-700 leading-relaxed text-sm">
                {slide.solution}
              </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-slate-50 rounded-xl border-2 border-slate-200 p-4">
              <div className="flex items-center gap-2 mb-4 text-slate-800">
                ...
                <h4 className="font-bold text-base">Stakeholders & Users</h4>
              </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {slide.stakeholders?.map((s, i) => (
                      <span key={i} className="px-2 py-1 bg-white rounded-lg border border-blue-300 text-blue-700 text-xs font-semibold">
                        {s}
                      </span>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {slide.endUsers?.map((u, i) => (
                      <span key={i} className="px-2 py-1 bg-white rounded-lg border border-green-300 text-green-700 text-xs font-semibold">
                        {u}
                      </span>
                    ))}
                  </div>
            ...
            {/* Pricing */}
            <div className="bg-blue-600 rounded-xl text-white p-4 flex-grow shadow-lg">
              <div className="flex items-center gap-2 mb-3">
                <DollarSign size={20} strokeWidth={2.5} />
                <h4 className="font-bold text-base">Estimated Pricing</h4>
              </div>
              ...
              <div className="text-xs text-blue-100 font-semibold mt-3 pt-3 border-t border-blue-400">
                {slide.pricingRange}
              </div>
            </div>
